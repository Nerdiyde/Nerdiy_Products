# Raspberry Pi 5 & RaspberryPi M.2 HAT+ Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5 with the official Raspberry Pi M.2 HAT+.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 together with the official M.2 HAT+ while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all ports while accommodating the M.2 NVMe SSD or AI Module.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your high-performance storage or AI projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5 with the official M.2 HAT+.

- **Product Name**: Raspberry Pi 5 & RaspberryPi M.2 HAT+ Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1022683-raspberry-pi-5-raspberrypi-m2-hat-housing-by-nerdi)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 5 with the official Raspberry Pi M.2 HAT+. It provides proper ventilation while accommodating M.2 modules (NVMe SSD or AI accelerator) and maintains full access to all GPIO pins, USB ports, Ethernet, and dual micro-HDMI connections.
...
- **[🎨 Printables Store](https://www.printables.com/model/1022683-raspberry-pi-5-raspberrypi-m2-hat-housing-by-nerdi)** - Download the STL files here
...
| 1x | Raspberry Pi M.2 HAT+ | B0D1JT4G5L | [Amazon](https://www.amazon.de/dp/B0D1JT4G5L?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | NVMe SSD M.2 2230/2242 (e.g., 256GB) | B0BLHJ4C3D | [Amazon](https://www.amazon.de/dp/B0BLHJ4C3D?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1022683-raspberry-pi-5-raspberrypi-m2-hat-housing-by-nerdi)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1022683-raspberry-pi-5-raspberrypi-m2-hat-housing-by-nerdi) (free download)
...
4. **Assembly**
   ...
   - Install M.2 module (NVMe SSD or AI accelerator) into the Raspberry Pi M.2 HAT+
   - Connect the HAT+ ribbon cable to the Raspberry Pi 5 PCIe connector
   - Install M2 threaded inserts into designated holes using soldering iron
   - Mount the assembled Pi+HAT+M.2 into the housing base
   - Secure the top cover with M2x20 countersunk screws
   - Verify M.2 module has proper clearance and all ports are accessible
...
5. **Installation**
   ...
   - Connect power supply (USB-C 27W power input recommended for M.2 modules)
