# Raspberry Pi 5 & 7" Touch Display 2 Frame - Vertical (No Cutout) by Nerdiy.de
...
Build a professional protective frame for your Raspberry Pi 5 with integrated 7" Touch Display 2 mounting. This vertical mounting variant without top-side cutout.
...
This product provides 3D-printable display frame parts for Raspberry Pi 5 with support for 7" Touch Display 2 in vertical orientation.

- **Product Name**: Raspberry Pi 5 & 7" Touch Display 2 Frame - Vertical (No Cutout)
- **Display Type**: 7" Touch Display 2
- **Raspberry Pi Version**: Raspberry Pi 5
- **Mounting Style**: vertical
- **Cutout Configuration**: No Cutout
- **Printables URL**: [1279491-raspberry-pi-7-touch-display-2-frame-for-raspberry](https://www.printables.com/model/1279491-raspberry-pi-7-touch-display-2-frame-for-raspberry)
- **Cults3D URL**: [raspberry-pi-touch-display-2-housing-plain-vertical](https://cults3d.com/de/modell-3d/gadget/raspberry-pi-touch-display-2-housing-plain-vertical)
...
- **[🎨 Printables Store](https://www.printables.com/model/1279491-raspberry-pi-7-touch-display-2-frame-for-raspberry)** - Download the STL files here

### Alternative Sources
- **[🎭 Cults3D Store](https://cults3d.com/de/modell-3d/gadget/raspberry-pi-touch-display-2-housing-plain-vertical)** - Alternative download platform
