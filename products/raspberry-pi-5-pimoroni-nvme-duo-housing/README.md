# Raspberry Pi 5 & Pimoroni NVME Duo Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5 with Pimoroni NVME Duo integration.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 and the Pimoroni NVME Duo while protecting them from dust and physical damage.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your Raspberry Pi 5 dual storage expansion projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5 with Pimoroni NVME Duo support (including dual M.2 2280 SSD bays).

- **Product Name**: Raspberry Pi 5 & Pimoroni NVME Duo Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1022954-raspberry-pi-5-pimoroni-nvme-duo-housing-by-nerdiy)
- **Created**: February 2026
- **Note**: The housing provides protection and proper ventilation while maintaining full access to all ports, connectors, and the dual M.2 SSD bays.
...
- **[🎨 Printables Store](https://www.printables.com/model/1022954-raspberry-pi-5-pimoroni-nvme-duo-housing-by-nerdiy)** - Download the STL files here
...
| 4x | M2x25 Phillips Countersunk Screw | B01DKI5GDO | [Amazon](https://www.amazon.de/dp/B01DKI5GDO?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
| 1x | Pimoroni NVME Duo for RPi 5 | B0DBMJV15N | [Amazon](https://www.amazon.de/dp/B0DBMJV15N?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 2x | M.2 2280 NVMe SSD (optional) | B0BMQ2D89G | [Amazon](https://www.amazon.de/dp/B0BMQ2D89G?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1022954-raspberry-pi-5-pimoroni-nvme-duo-housing-by-nerdiy)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1022954-raspberry-pi-5-pimoroni-nvme-duo-housing-by-nerdiy) (free download)
   - Alternative: [Download from Cults3D](https://cults3d.com/de/modell-3d/gadget/raspberrypi-5-pimoroni-nvme-duo-gehaeuse)
...
4. **Assembly**
   ...
   - (Optional) Install up to 2x M.2 NVMe SSDs into the Pimoroni NVME Duo
   - Attach the Pimoroni NVME Duo to the Raspberry Pi 5
   - Secure the top cover with M2x25 screws
   - Verify all ports, connectors, and the dual M.2 SSD bays are accessible
...
5. **Installation**
   ...
   - Install and format the M.2 SSDs if using them
