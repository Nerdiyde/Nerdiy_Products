# Raspberry Pi5 & Waveshare PCIe M.2 Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5 with Waveshare PCIe to M.2 Adapter.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 together with the Waveshare PCIe to M.2 Adapter Board while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all ports while accommodating M.2 NVMe SSDs or other PCIe devices.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your high-performance storage or expansion projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5 with Waveshare PCIe M.2 Adapter.

- **Product Name**: Raspberry Pi5 & Waveshare PCIe M.2 Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1022967-raspberry-pi5-waveshare-pcie-m2-housing-by-nerdiyd)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 5 with the Waveshare PCIe to M.2 Adapter Board. It provides proper ventilation while accommodating M.2 modules (2230/2242/2280) and maintains full access to all GPIO pins, USB ports, Ethernet, and dual micro-HDMI connections.
...
| 1x | Waveshare PCIe to M.2 Adapter | B0CXLQ6LVL | [Amazon](https://www.amazon.de/dp/B0CXLQ6LVL?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1022967-raspberry-pi5-waveshare-pcie-m2-housing-by-nerdiyd)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1022967-raspberry-pi5-waveshare-pcie-m2-housing-by-nerdiyd) (free download)
...
4. **Assembly**
   ...
   - Install M.2 SSD into the Waveshare PCIe to M.2 Adapter Board
   - Connect the adapter board to the Raspberry Pi 5 PCIe connector using the ribbon cable
   - Install M2 threaded inserts into designated holes using soldering iron
   - Mount the assembled Pi+Adapter+SSD into the housing base
   - Secure the top cover with M2x20 countersunk screws
   - Verify M.2 SSD has proper clearance and all ports are accessible
