# Raspberry Pi 4 & DigiAmp+ HAT Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 4 with IQaudio DigiAMP+ integration.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 4 and the IQaudio DigiAMP+ while protecting them from dust and physical damage.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your Raspberry Pi 4 audio amplification projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 4 with IQaudio DigiAMP+ support.

- **Product Name**: Raspberry Pi 4 & DigiAmp+ HAT Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1279687-raspberry-pi-4-digiamp-hat-housing-by-nerdiyde)
...
- **[🎨 Printables Store](https://www.printables.com/model/1279687-raspberry-pi-4-digiamp-hat-housing-by-nerdiyde)** - Download the STL files here
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1279687-raspberry-pi-4-digiamp-hat-housing-by-nerdiyde)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1279687-raspberry-pi-4-digiamp-hat-housing-by-nerdiyde) (free download)
   - Alternative: [Download from Cults3D](https://cults3d.com/de/modell-3d/gadget/raspberrypi-4-digiamp-hat-housing)
...
4. **Assembly**
   ...
   - Attach the IQaudio DigiAMP+ to the Raspberry Pi 4
...
5. **Installation**
   ...
   - Boot up your Raspberry Pi 4 and configure audio software
