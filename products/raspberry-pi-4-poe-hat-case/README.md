# Raspberry Pi 4 POE HAT Case by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 4 with official PoE HAT.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 4 together with the official Power over Ethernet (PoE) HAT while protecting it from dust and physical damage. The housing provides proper ventilation for the PoE HAT's fan and maintains full access to all ports and connectors.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your network infrastructure projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 4 with PoE HAT.

- **Product Name**: Raspberry Pi 4 POE HAT case by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1285610-raspberry-pi-4-poe-hat-case-by-nerdiyde)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 4 with the official PoE HAT installed. It provides proper ventilation for the PoE HAT's cooling fan while maintaining full access to all GPIO pins, USB ports, and Ethernet connection.
...
- **[🎨 Printables Store](https://www.printables.com/model/1285610-raspberry-pi-4-poe-hat-case-by-nerdiyde)** - Download the STL files here
...
| 1x | Raspberry Pi PoE HAT | B07ZWN49G9 | [Amazon](https://www.amazon.de/dp/B07ZWN49G9?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | Micro SD Card 64GB | B07FCMBLV6 | [Amazon](https://www.amazon.de/dp/B07FCMBLV6?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | PoE Switch or Injector | B0763TGBTS | [Amazon](https://www.amazon.de/dp/B0763TGBTS?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | Ethernet Cable | B00N2VILDM | [Amazon](https://www.amazon.de/dp/B00N2VILDM?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
> 💡 **Print Orientation**: I highly recommend printing the parts in the already defined orientation. The defined orientation is intended to maximize the structural integrity of the part and ensure proper ventilation channels for the PoE HAT fan.
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1285610-raspberry-pi-4-poe-hat-case-by-nerdiyde)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1285610-raspberry-pi-4-poe-hat-case-by-nerdiyde) (free download)
...
4. **Assembly**
   ...
   - Install the PoE HAT onto the GPIO header
   - Secure the housing parts with M2x20 countersunk screws
   - Verify PoE HAT fan has clearance and ventilation

5. **Installation**
   - Mount the complete housing assembly in your desired location
   - Ensure proper ventilation around the unit for heat dissipation
   - Connect Ethernet cable to the Raspberry Pi
   - Connect Ethernet cable to PoE switch or injector
   - The PoE HAT will power the Raspberry Pi automatically
   - Boot up your Raspberry Pi 4

6. **Maintenance**
   - Periodically clean dust from ventilation areas and fan
