# Raspberry Pi 5 Case by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all ports and connectors.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your Raspberry Pi 5 projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5.

- **Product Name**: Raspberry Pi 5 Case by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1285626-raspberry-pi-5-case-by-nerdiyde)
- **Created**: February 2026
- **Note**: The housing provides protection and proper ventilation while maintaining full access to all GPIO pins, USB ports, Ethernet, and dual micro-HDMI connections. Compatible with the new Raspberry Pi 5 PCIe connector.
...
- **[🎨 Printables Store](https://www.printables.com/model/1285626-raspberry-pi-5-case-by-nerdiyde)** - Download the STL files here
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1285626-raspberry-pi-5-case-by-nerdiyde)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1285626-raspberry-pi-5-case-by-nerdiyde) (free download)
...
4. **Assembly**
   ...
   - Verify all ports, GPIO pins, and PCIe connector are accessible
