# Raspberry Pi 5 & Waveshare Connector & USB 3.0 PCB Adapter Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5 with Waveshare Connector & USB 3.0 PCB Adapter.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 together with the Waveshare Connector and USB 3.0 PCB Adapter while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all connectors routed through the Waveshare adapter plus the additional USB 3.0 ports.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your projects requiring expanded connectivity.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5 with Waveshare Connector & USB 3.0 PCB Adapter.

- **Product Name**: Raspberry Pi 5 & Waveshare connector & USB 3.0 PCB Adapter Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1280623-raspberry-pi-5-waveshare-connector-usb-30-pcb-adap)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 5 with the Waveshare Connector and USB 3.0 PCB Adapter. It provides clean cable routing, additional USB 3.0 ports, and maintains full access to all GPIO pins, USB ports, Ethernet, dual micro-HDMI connections, and adapted connectors.
...
- **[🎨 Printables Store](https://www.printables.com/model/1280623-raspberry-pi-5-waveshare-connector-usb-30-pcb-adap)** - Download the STL files here
...
| Qty | Component | ASIN (DE) | Amazon (DE) |
|-----|-----------|-----------|-------------|
| 16x | M2 Threaded Insert | B08DDBWKZF | [Amazon](https://www.amazon.de/dp/B08DDBWKZF?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
| 4x | M2x6 Countersunk Screw | B0957W34XS | [Amazon](https://www.amazon.de/dp/B0957W34XS?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
| 1x | USB 3.0 PCB Adapter | B0D9CPHX15 | [Amazon](https://www.amazon.de/dp/B0D9CPHX15?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1280623-raspberry-pi-5-waveshare-connector-usb-30-pcb-adap)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1280623-raspberry-pi-5-waveshare-connector-usb-30-pcb-adap) (free download)
...
4. **Assembly**
   ...
   - Mount the Raspberry Pi 5 into the housing base using M2x6 countersunk screws (4x)
   - Connect the Waveshare Connector Adapter to the appropriate ports
   - Connect the USB 3.0 PCB Adapter to the PCIe connector
   - Route cables through the designated openings
   - Secure the housing parts with M2x20 countersunk screws (8x)
   - Verify all connectors and USB 3.0 ports are accessible

5. **Installation**
   - Mount the complete housing assembly in your desired location
   - Ensure proper ventilation around the unit
   - Connect power supply (USB-C 27W power input)
   - Connect peripherals through the Waveshare adapter and USB 3.0 ports
