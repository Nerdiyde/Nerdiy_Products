# Raspberry Pi 4 & Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display Frame - Horizontal (Integrated) by Nerdiy.de
...
Build a professional protective frame for your Raspberry Pi 4 with integrated Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display mounting. This horizontal mounting variant with integrated mounting for high-resolution display.

Here we offer you the STL files for 3D-printed housing parts, specifically developed to securely hold the Raspberry Pi 4 and Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display while protecting the components from dust and physical damage.

---

## 📋 About This Product

This product provides 3D-printable display frame parts for Raspberry Pi 4 with support for Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display with Waveshare 10.1" 1920x1200 high-resolution capacitive touch display.

- **Product Name**: Raspberry Pi 4 & Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display Frame - Horizontal (Integrated)
- **Display Type**: Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display
...
| 1x | Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display | B0DJR28L7R | [Amazon](https://www.amazon.de/dp/B0DJR28L7R?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
4. **Mount Components**
   ...
   - Attach Waveshare 10.1" 1920x1200 High-Resolution Capacitive Touch Display with mounting screws
