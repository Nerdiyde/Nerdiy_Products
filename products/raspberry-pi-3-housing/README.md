# Raspberry Pi 3 Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 3 Model B/B+.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 3 while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all ports and connectors.

With the provided STL files, you can easily create your own housing parts on your 3D printer and integrate them into your Raspberry Pi 3 projects.

---

## 📋 About This Product

This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 3 Model B/B+.

- **Product Name**: Raspberry Pi 3 Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1285583-raspberry-pi-3-housing-by-nerdiyde)
- **Created**: February 2026
- **Note**: The housing provides protection and proper ventilation while maintaining full access to all GPIO pins, USB ports, Ethernet, and HDMI connections.
...
- **[🎨 Printables Store](https://www.printables.com/model/1285583-raspberry-pi-3-housing-by-nerdiyde)** - Download the STL files here
...
| Qty | Component | ASIN (DE) | Amazon (DE) |
|-----|-----------|-----------|-------------|
| 1x | Raspberry Pi 3 Model B+ | B07BDR5PDW | [Amazon](https://www.amazon.de/dp/B07BDR5PDW?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | Raspberry Pi Power Supply (Official) | B0B4VF2PPX | [Amazon](https://www.amazon.de/dp/B0B4VF2PPX?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1285583-raspberry-pi-3-housing-by-nerdiyde)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1285583-raspberry-pi-3-housing-by-nerdiyde) (free download)
...
4. **Assembly**
   ...
   - Mount the Raspberry Pi 3 into the housing base
...
5. **Installation**
   ...
   - Connect power supply (Micro USB power input)
   - Connect peripherals and network cables as needed
   - Boot up your Raspberry Pi 3
