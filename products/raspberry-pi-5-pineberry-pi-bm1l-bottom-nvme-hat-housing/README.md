# Raspberry Pi 5 & Pineberry Pi BM1L Bottom NVME HAT Housing by Nerdiy.de

---

## 🎯 Project Overview

Build a professional protective housing for your Raspberry Pi 5 with Pineberry Pi BM1L Bottom NVMe HAT.

Here we offer you the STL files for 3D-printed housing parts, which have been specifically developed to securely hold the Raspberry Pi 5 together with the Pineberry Pi BM1L Bottom NVMe HAT while protecting it from dust and physical damage. The housing provides proper ventilation and maintains full access to all ports while accommodating the NVMe SSD mounted underneath the board.
...
This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 5 with Pineberry Pi BM1L Bottom NVMe HAT.

- **Product Name**: Raspberry Pi 5 & Pineberry Pi BM1L Bottom NVME HAT Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/782983-raspberry-pi-5-pineberry-pi-bm1l-bottom-nvme-hat-h)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 5 with the Pineberry Pi BM1L NVMe HAT mounted on the bottom side. It provides proper ventilation while accommodating M.2 NVMe SSDs (2230/2242/2280) and maintains full access to all GPIO pins, USB ports, Ethernet, and dual micro-HDMI connections.
...
- **[🎨 Printables Store](https://www.printables.com/model/782983-raspberry-pi-5-pineberry-pi-bm1l-bottom-nvme-hat-h)** - Download the STL files here
...
| 4x | M2x16 Countersunk Screw | B0957SL8PN | [Amazon](https://www.amazon.de/dp/B0957SL8PN?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
| 1x | Pineberry Pi BM1L Bottom NVMe HAT | B0CRJ7X7CY | [Amazon](https://www.amazon.de/dp/B0CRJ7X7CY?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
> 💡 **Print Orientation**: I highly recommend printing the parts in the already defined orientation. The defined orientation is intended to maximize the structural integrity of the part and accommodate the bottom-mounted NVMe HAT.
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/782983-raspberry-pi-5-pineberry-pi-bm1l-bottom-nvme-hat-h)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/782983-raspberry-pi-5-pineberry-pi-bm1l-bottom-nvme-hat-h) (free download)
...
4. **Assembly**
   ...
   - Install NVMe SSD into the Pineberry Pi BM1L HAT
   - Connect the HAT to the Raspberry Pi 5 PCIe connector (bottom side)
   ...
   - Secure the top cover with M2x16 countersunk screws
