...
This product provides 3D-printable protective housing and mounting parts for Raspberry Pi 4 with Waveshare Connector Adapter.

- **Product Name**: Raspberry Pi 4 & Waveshare Connector Adapter Housing by Nerdiy.de
- **Printables Store**: [🎨 View on Printables](https://www.printables.com/model/1287071-raspberry-pi-4-waveshare-connector-adapter-housing)
- **Created**: February 2026
- **Note**: The housing is specifically designed for the Raspberry Pi 4 with the Waveshare Connector Adapter. It provides clean cable routing and maintains full access to all GPIO pins, USB ports, Ethernet, and adapted connectors.
...
- **[🎨 Printables Store](https://www.printables.com/model/1287071-raspberry-pi-4-waveshare-connector-adapter-housing)** - Download the STL files here
...
| 1x | Waveshare Connector Adapter | B0D5VBSKF4 | [Amazon](https://www.amazon.de/dp/B0D5VBSKF4?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
| 1x | USB-C Power Supply 15W | B07TZ89BT7 | [Amazon](https://www.amazon.de/dp/B07TZ89BT7?tag=nerdiyde018-21&linkCode=ogi&th=1&psc=1) |
...
1. **Gather Your Materials**
   ...
   - For STL files, [download from Printables](https://www.printables.com/model/1287071-raspberry-pi-4-waveshare-connector-adapter-housing)

2. **Download 3D Files**
   - [🎨 Download from Printables](https://www.printables.com/model/1287071-raspberry-pi-4-waveshare-connector-adapter-housing) (free download)
...
4. **Assembly**
   ...
   - Mount the Raspberry Pi 4 into the housing base using M2x6 screws (2x)
